...
function eachBehavior(groups, visit) {
    groups.forEach((group, groupIndex) => group.gameObjects.forEach((gameObject, objectIndex) => gameObject.behaviors.forEach((_behavior, behaviorIndex) => visit(groupIndex, objectIndex, behaviorIndex))));
}
