...
const colony_achievements_1 = require("./known-behaviors/colony-achievements");
const parser_5 = require("./known-behaviors/colony-achievements/parser");
const EXTRA_DATA_PARSERS = {
    ...
    [colony_achievements_1.ColonyAchievementTrackerBehavior]: {
        parse: parser_5.parseColonyAchievementsExtraData,
        unparse: parser_5.unparseColonyAchievementsExtraData
    }
};
